...
static PACKAGES: &[&str] = &["gtksourceview-4"];
...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "GtkSourceCompletion",
        Layout {
            size: size_of::<GtkSourceCompletion>(),
            alignment: align_of::<GtkSourceCompletion>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceCompletionContext>(),
            alignment: align_of::<GtkSourceCompletionContext>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceCompletionError>(),
            alignment: align_of::<GtkSourceCompletionError>(),
        },
    ),
    (
        "GtkSourceCompletionInfo",
        Layout {
            size: size_of::<GtkSourceCompletionInfo>(),
            alignment: align_of::<GtkSourceCompletionInfo>(),
        },
    ),
    (
        "GtkSourceCompletionInfoClass",
        Layout {
            size: size_of::<GtkSourceCompletionInfoClass>(),
            alignment: align_of::<GtkSourceCompletionInfoClass>(),
        },
    ),
    (
        "GtkSourceCompletionItem",
        Layout {
            size: size_of::<GtkSourceCompletionItem>(),
            alignment: align_of::<GtkSourceCompletionItem>(),
        },
    ),
    (
        "GtkSourceCompletionItemClass",
        Layout {
            size: size_of::<GtkSourceCompletionItemClass>(),
            alignment: align_of::<GtkSourceCompletionItemClass>(),
        },
    ),
    (
        "GtkSourceCompletionProposalIface",
        Layout {
            size: size_of::<GtkSourceCompletionProposalIface>(),
            alignment: align_of::<GtkSourceCompletionProposalIface>(),
        },
    ),
    (
        "GtkSourceCompletionProviderIface",
        Layout {
            size: size_of::<GtkSourceCompletionProviderIface>(),
            alignment: align_of::<GtkSourceCompletionProviderIface>(),
        },
    ),
    (
    ...
    (
        "GtkSourceFileLoader",
        Layout {
            size: size_of::<GtkSourceFileLoader>(),
            alignment: align_of::<GtkSourceFileLoader>(),
        },
    ),
    (
    ...
    (
        "GtkSourceFileSaver",
        Layout {
            size: size_of::<GtkSourceFileSaver>(),
            alignment: align_of::<GtkSourceFileSaver>(),
        },
    ),
    (
    ...
    (
        "GtkSourceGutter",
        Layout {
            size: size_of::<GtkSourceGutter>(),
            alignment: align_of::<GtkSourceGutter>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceGutterRendererState>(),
            alignment: align_of::<GtkSourceGutterRendererState>(),
        },
    ),
    (
    ...
    (
        "GtkSourceLanguage",
        Layout {
            size: size_of::<GtkSourceLanguage>(),
            alignment: align_of::<GtkSourceLanguage>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceLanguageManager>(),
            alignment: align_of::<GtkSourceLanguageManager>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceMarkAttributes>(),
            alignment: align_of::<GtkSourceMarkAttributes>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceSearchContext>(),
            alignment: align_of::<GtkSourceSearchContext>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceSpaceDrawer>(),
            alignment: align_of::<GtkSourceSpaceDrawer>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceStyleScheme>(),
            alignment: align_of::<GtkSourceStyleScheme>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceStyleSchemeManager>(),
            alignment: align_of::<GtkSourceStyleSchemeManager>(),
        },
    ),
    (
    ...
    (
        ...
        Layout {
            size: size_of::<GtkSourceUndoManagerIface>(),
            alignment: align_of::<GtkSourceUndoManagerIface>(),
        },
    ),
    (
        "GtkSourceView",
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    (
        "(guint) GTK_SOURCE_COMPLETION_ACTIVATION_USER_REQUESTED",
        "2",
    ),
