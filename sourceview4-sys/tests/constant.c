...
int main() {
    ...
    PRINT_CONSTANT((guint) GTK_SOURCE_COMPLETION_ACTIVATION_INTERACTIVE);
    PRINT_CONSTANT((guint) GTK_SOURCE_COMPLETION_ACTIVATION_NONE);
    PRINT_CONSTANT((guint) GTK_SOURCE_COMPLETION_ACTIVATION_USER_REQUESTED);
    PRINT_CONSTANT((gint) GTK_SOURCE_COMPLETION_ERROR_ALREADY_BOUND);
    PRINT_CONSTANT((gint) GTK_SOURCE_COMPLETION_ERROR_NOT_BOUND);
    ...
    PRINT_CONSTANT((guint) GTK_SOURCE_GUTTER_RENDERER_STATE_CURSOR);
    PRINT_CONSTANT((guint) GTK_SOURCE_GUTTER_RENDERER_STATE_NORMAL);
    PRINT_CONSTANT((guint) GTK_SOURCE_GUTTER_RENDERER_STATE_PRELIT);
    PRINT_CONSTANT((guint) GTK_SOURCE_GUTTER_RENDERER_STATE_SELECTED);
