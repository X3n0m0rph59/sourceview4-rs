...
impl FileLoader {
    ...
    ///
    /// This method returns an instance of [`FileLoaderBuilder`] which can be used to create [`FileLoader`] objects.
...
pub trait FileLoaderExt: 'static {
    ...
    //
    //fn load_async_future<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, io_priority: glib::Priority, progress_callback: P, progress_callback_notify: Fn() + 'static) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>>;
}
